...
const ICONS: Record<string, React.ReactNode> = {
  ...
  vibe: (
    <svg width="18" height="18" viewBox="0 0 18 18">
      <defs>
        <linearGradient id="ftr-vibe-talent" x1="0" y1="0" x2="18" y2="18">
  ...
  workforms: (
    <svg width="18" height="18" viewBox="0 0 18 18">
      <defs>
        <linearGradient id="ftr-wf-talent" x1="0" y1="0" x2="18" y2="18">
          <stop stopColor="#f8467d" />
          <stop offset="1" stopColor="#a358df" />
        </linearGradient>
      </defs>
      <path d="M4 3h10M4 8h7M4 13h4" stroke="url(#ftr-wf-talent)" strokeWidth="2.6" strokeLinecap="round" />
    </svg>
  ),
};
    ...
    >
      <div className="mx-auto max-w-[1296px] px-6 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-10 md:grid-cols-3 lg:grid-cols-[1.39fr_1.03fr_1.7fr_1.39fr_1.37fr_1fr]">
          ...
          <div>
            <a href="/talent" className="mb-2 flex h-10 items-center gap-[7px]">
              <Image
                src="/talentlogo.png"
                alt="fyerx.com"
                width={175}
