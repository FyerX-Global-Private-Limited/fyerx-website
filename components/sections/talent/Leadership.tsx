  ...
  return (
    <section className="ldr-section">
      ...
      <div className="ldr-container">
        <h2 className="ldr-title">From sourcing to onboarding, in one place</h2>

        <div className="ldr-grid">
          <FeatureCard
            icon={<ArrowIcon />}
            title="Your hiring process, connected end to end"
            body="Sourcing, screening, and offer stages stay linked, so nothing slips between handoffs."
          />

          <FeatureCard
            icon={<PillsIcon />}
            title="More than just sending resumes"
            body="Assessments, verification, and compliance run in the background, so every hire is properly vetted."
          />
