...
/* ------------------------------------------------------------------ */
/*  Leadership — "From sourcing to onboarding, in one place" section   */
/*                                                                     */
...
@media (min-width:1024px){
  .ldr-grid{margin-top:56px;grid-template-columns:repeat(3,1fr);}
  ...
  return (
    <section className="ldr-section">
      ...
      <div className="ldr-container">
        <h2 className="ldr-title">From the role brief to a ready-to-join hire</h2>

        <div className="ldr-grid">
          <FeatureCard
            icon={<ArrowIcon />}
            title="The brief is made usable"
            body="We define the skills, outcomes, seniority, availability, engagement model, and non-negotiables before sourcing begins."
          />

          <FeatureCard
            icon={<PillsIcon />}
            title="Every handoff stays visible"
            body="Shortlisting, feedback, interviews, offers, verification, and onboarding move through one managed process."
          />
