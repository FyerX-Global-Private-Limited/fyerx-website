...
const features = [
  ...
  "Clear timelines on every role",
  "Flexible engagement models",
  "Quick turnaround on urgent roles",
];
    ...
    <section className="ent">
      <div className="ent__card">
        <div className="ent__left">
          <h2 className="ent__title">Talk to an expert about your hiring needs</h2>

          <p className="ent__subtitle">
            Get a clear view of the roles you're trying to fill, and the
            right approach to fill them, with support along the way.
          </p>
