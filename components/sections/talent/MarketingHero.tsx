...
const WORDS = [
  { w: "Joins", bg: "#d8e9fb", dot: "#2383e2", text: "#15335a" },
  { w: "Strengthens", bg: "#e8e0fb", dot: "#8b5cf6", text: "#3b2a6b" },
  { w: "Grows", bg: "#d5eed3", dot: "#36a852", text: "#14351f" },
  { w: "Completes", bg: "#fdeecc", dot: "#f2a33c", text: "#6b4a12" },
  { w: "Elevates", bg: "#fde0d3", dot: "#ef7234", text: "#6b2f12" },
] as const;
    ...
    >
      ...
      <div className="mx-auto max-w-[1360px] text-center">
        ...
        <p className="mt-4 text-[15px] leading-[1.5] text-[#191918] sm:mt-5 sm:text-[17px] lg:mt-[26px] lg:text-[20px]">
          Contract staffing, RPO, and executive search that get the right
          people in place, without slowing your business down.
        </p>
        ...
        <div className="mt-6 flex w-full flex-col items-center justify-center gap-3 sm:mt-[30px] sm:w-auto sm:flex-row sm:gap-[22px]">
          <button
            type="button"
            className="inline-flex h-[44px] w-full items-center justify-center rounded-[10px] bg-[#0B2E59] px-7 text-[16px] font-semibold text-white transition-colors duration-150 hover:bg-[#092547] sm:h-[47px] sm:w-auto sm:text-[18px]"
          >
            Get Started
          </button>
          <button
