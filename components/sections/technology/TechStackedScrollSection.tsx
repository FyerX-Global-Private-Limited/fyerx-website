...
import {
  ...
  type TechCaseStudy,
  type TechCaseStudyMetric,
} from "@/data/technology-case-studies";

const STACK_TOP = 88;
const PEEK = 26;

/** Monday-style pastel card fills — blue-led palette for Technology. */
const CARD_PALETTES = [
  { cardBg: "#E6E0FF", panelBg: "#F0EDFF", accent: "#7c3aed" },
  { cardBg: "#C5DAF5", panelBg: "#D8E9FB", accent: "#1F5C99" },
  { cardBg: "#EEF0FA", panelBg: "#E4E8F8", accent: TECH_HOME.primary },
  { cardBg: "#D8E9FB", panelBg: "#E8F1FB", accent: "#4B5FDB" },
  { cardBg: "#E4E8F8", panelBg: "#F0F2FC", accent: "#3D52C7" },
  { cardBg: "#C5DAF5", panelBg: "#D8E9FB", accent: "#20287A" },
] as const;
...
function MetricsMockup({
  ...
  return (
    <div className="relative flex h-full min-h-[280px] w-full items-center justify-center p-4 sm:min-h-[420px] sm:p-6">
      <div
        ...
        <div className="grid md:grid-cols-2">
          <div className="flex flex-col p-6 sm:p-10 md:p-12" style={{ backgroundColor: palette.cardBg }}>
            ...
            <Link
              ...
              style={{ backgroundColor: TECH_HOME.primary, color: TECH_HOME.accent }}
            >
    ...
    <section className="w-full overflow-x-clip bg-white">
      <div className="mx-auto w-full max-w-[1400px]">
        <div className="max-w-2xl">
          ...
          >
            Featured delivery scenarios
          </p>
          <h2 className="section-heading mt-3">
            Delivery programmes that{" "}
            <span className="tech-gradient-text">move the business</span>
          </h2>
        </div>
