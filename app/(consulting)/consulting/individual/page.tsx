import BookingCTA from "@/components/sections/consulting/BookingCTA";
    ...
    <>
      <section className="max-w-3xl mx-auto px-6 py-24">
        ...
        <p className="text-lg text-zinc-600 leading-8 mb-10">
          One-on-one sessions tailored to your personal goals. Our consultants
          create a safe, confidential space for you to explore challenges and
          build resilience.
        </p>
