  ...
  return (
    <section className="max-w-2xl mx-auto px-6 py-24">
      ...
      <p className="text-lg text-zinc-600 mb-10">
        Schedule your first consulting session with a Fyerx consultant. Choose
      ...
      <form className="flex flex-col gap-5">
        ...
        <select className="border border-zinc-200 rounded-lg px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-zinc-900 bg-white">
          ...
          <option value="individual">Individual consulting</option>
          <option value="group">Group Session</option>
          <option value="couples">Couples consulting</option>
        </select>
        <textarea
