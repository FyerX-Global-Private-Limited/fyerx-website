...
export const MARKETING_MENU_CATEGORIES: MobileMenuCategory[] = [
  {
    ...
    tint: "#FFF6E6",
    iconColor: "#FDAB3D",
    image: `${ICONS}/Marketing & Consulting.webp`,
    items: [
      { label: "Go-to-Market Strategy", icon: "chart", href: "#", image: `${ICONS}/Go-to-Market Strategy.webp` },
      { label: "ICP & Buyer Personas", icon: "personPlus", href: "#", image: `${ICONS}/ICP & Buyer Persona Definition.webp` },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Landing Pages & Nurture", icon: "formEdit", href: "#", image: `${ICONS}/Landing Pages & Nurture.webp` },
      { label: "Attribution & Pipeline Reporting", icon: "chart", href: "#", image: `${ICONS}/Attribution & Pipeline Reporting.webp` },
    ],
  },
  {
    ...
    tint: "#E8F4FF",
    iconColor: "#579BFC",
    image: `${ICONS}/Search & AI Visibility.webp`,
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Reporting & Spend Guardrails", icon: "chart", href: "#", image: `${ICONS}/Reporting & Spend Guardrails.webp` },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Analytics & ROI Tracking", icon: "chart", href: "#", image: `${ICONS}/Analytics & ROI Tracking.webp` },
    ],
  },
  {
    ...
    tint: "#F3EEFF",
    iconColor: "#A25DDC",
    image: `${ICONS}/Branding & Design.webp`,
    items: [
      { label: "Brand Strategy & Identity", icon: "tag", href: "#", image: `${ICONS}/Brand Strategy & Identity.webp` },
      ...
      { label: "Content Strategy & Production", icon: "doc", href: "#", image: `${ICONS}/Content Strategy & Production.webp` },
